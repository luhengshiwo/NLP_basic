...
# props = dict(facecolor='black', shrink=0.1)
# plt.annotate('Saturating', xytext=(2, 0.5), xy=(2.8, 0.9), arrowprops=props, fontsize=14, ha="center")
# plt.annotate('Saturating', xytext=(-2, -0.5), xy=(-2.8, -0.9), arrowprops=props, fontsize=14, ha="center")
# plt.annotate('Linear', xytext=(1, -0.5), xy=(0, 0), arrowprops=props, fontsize=14, ha="center")
# plt.grid(True)
# plt.title("Tanh activation function", fontsize=14)
# plt.axis([-3, 3, -1.2, 1.2])

# save_fig("tanh_saturation_plot")
# plt.show()
...
plt.plot(z, relu(z, 0.05), "b-", linewidth=2)
plt.plot([-5, 5], [0, 0], 'k-')
